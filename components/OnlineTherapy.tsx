        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-white font-medium text-sm transition-all hover:-translate-y-px shadow-sm hover:shadow-md"
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, rgba(201,168,76,0.12), transparent)",
