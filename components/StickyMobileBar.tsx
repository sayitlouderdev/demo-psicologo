...
import { DOCTOR, MAPS_URL, whatsappUrl } from "@/lib/constants";
...
export function StickyMobileBar() {
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 md:hidden border-t border-gray-200 shadow-lg"
    ...
    >
      <div className="grid grid-cols-3" style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
        ...
        <a
          ...
          className="flex flex-col items-center justify-center py-3 gap-1 text-xs font-medium transition-colors border-x border-gray-200"
